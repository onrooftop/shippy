...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x58, 0x0a, 0x05, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x14,
	...
	0x09, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x09,
	...
	0x72, 0x72, 0x6f, 0x72, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x32, 0xcb, 0x01, 0x0a,
	0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x24, 0x0a, 0x06,
	...
	0x73, 0x65, 0x12, 0x21, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x0a, 0x2e, 0x75, 0x73, 0x65, 0x72,
...
var file_proto_user_user_proto_depIdxs = []int32{
	2, // 0: user.Token.errors:type_name -> user.Error
	0, // 1: user.Response.user:type_name -> user.User
	0, // 2: user.Response.users:type_name -> user.User
	2, // 3: user.Response.errors:type_name -> user.Error
	0, // 4: user.UserService.Create:input_type -> user.User
	0, // 5: user.UserService.Get:input_type -> user.User
	3, // 6: user.UserService.GetAll:input_type -> user.Request
	0, // 7: user.UserService.Auth:input_type -> user.User
	1, // 8: user.UserService.ValidateToken:input_type -> user.Token
	4, // 9: user.UserService.Create:output_type -> user.Response
	4, // 10: user.UserService.Get:output_type -> user.Response
	4, // 11: user.UserService.GetAll:output_type -> user.Response
	1, // 12: user.UserService.Auth:output_type -> user.Token
	1, // 13: user.UserService.ValidateToken:output_type -> user.Token
